...
zikacasesraw <- read.csv("rawdata/zika_cases_curr.csv", header = TRUE, sep = ",")
...
write.csv(merge2, file = "data/SIM_region_curr.csv", row.names = FALSE)
write.csv(mergestate, file = "data/SIM_state_curr.csv", row.names = FALSE)
